<template>
  <MpFlex
    ...
    padding="2"
  >
    <MpFlex direction="column" :width="{ base: '100%', md: '800px' }" height="full">
      <MpFlex gap="2" alignItems="center" p="4" pb="0">
        <MpButton left-icon="arrows-left" variant="ghost" size="sm" @click="navigateTo('/')" />
...
<script setup lang="ts">
  ...
  import { MpAireneChatInput, MpAireneChatBubble, MpFlex, MpText, MpButton } from '@mekari/pixel3'
