...
export default defineMcpPrompt({
  ...
  inputSchema: {
    figmaLink: z.string()
      .describe('Figma design link or node URL (e.g., https://figma.com/design/file-key/file-name?node-id=1-2)'),
    componentName: z.string().optional()
      .describe('(Optional) Target Pixel 3 component name to implement (e.g., MpButton, MpCard, MpInput). If not provided, will be determined from Figma design'),
  },
