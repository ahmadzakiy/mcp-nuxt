...
function toolCallAccuracy({ actualCalls, expectedCalls }: { 
  ...
  data: async () => [
    {
      ...
      expected: [{ toolName: 'get-component', input: { componentName: 'Button' } }],
    },
    {
      input: 'How do I use MpButton?',
      expected: [{ toolName: 'get-component', input: { componentName: 'MpButton' } }],
    },
    {
      input: 'What are the props for mp-button component?',
      expected: [{ toolName: 'get-component', input: { componentName: 'mp-button' } }],
    },
    {
      input: 'Get the Card component documentation',
      expected: [{ toolName: 'get-component', input: { componentName: 'Card' } }],
    },
  ],
  task: async (input) => {
  ...
  data: async () => [
    {
      ...
      expected: [{ toolName: 'get-docs', input: { query: 'how to setup Pixel library' } }],
    },
    {
    ...
    },
    {
      ...
      expected: [{ toolName: 'get-docs', input: { query: 'installation guide' } }],
    },
  ],
  task: async (input) => {
    const mcp = await createMCPClient({ transport: { type: 'http', url: MCP_URL } })
  ...
  data: async () => [
    {
      ...
      expected: [{ toolName: 'get-docs', input: { query: 'difference between token 2.1 and 2.4' } }],
    },
    {
    ...
    },
    {
      ...
      expected: [{ toolName: 'get-docs', input: { query: 'token v2.1 or v2.4' } }],
    },
  ],
  task: async (input) => {
    const mcp = await createMCPClient({ transport: { type: 'http', url: MCP_URL } })
...
evalite('Multi-Step Workflow - Component and Documentation', {
  data: async () => [
    {
      input: 'Show me the Button component documentation and how to setup Pixel',
      expected: [
    ...
    {
      input: 'I need documentation for the Card component and information about design tokens',
      expected: [
  ...
  data: async () => [
    {
      ...
      expected: [{ toolName: 'get-docs', input: { query: 'available components' } }],
    },
    {
      input: 'Get me the Input component details',
      expected: [{ toolName: 'get-component', input: { componentName: 'Input' } }],
    },
    {
      input: 'How do I customize components?',
      expected: [{ toolName: 'get-docs', input: { query: 'customize components' } }],
    },
    {
      input: 'Show Avatar component usage',
      expected: [{ toolName: 'get-component', input: { componentName: 'Avatar' } }],
    },
  ],
  task: async (input) => {
    const mcp = await createMCPClient({ transport: { type: 'http', url: MCP_URL } })
